  ...
  <div class="columns is-marginless is-centered is-mobile">
    <div class="column is-11">
      <div class="columns is-mobile">
        <div class="column">
          <h1 class="title is-3">Crear director</h1>
        </div>
      </div>
      <hr class="is-marginless">
      <form class="createForm" action="{{route('director.store')}}" method="post" enctype="multipart/form-data">
        @include('directors.form')
        <div class="field">
          <div class="control">
            <a href="{{ route('directors.index') }}" class="button is-light">Cancelar</a>
            <button type="submit" class="submitButton button is-success">Crear director</button>
          </div>
        </div>
      </form>
    </div>
